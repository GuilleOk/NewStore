  ...
  return (
    <div className='footer'>
      ...
      <div className='d-none d-lg-flex SecondContainer px-5 py-3'>
        ...
        <div className="d-none d-lg-inline textFooter"><strong>Follow us in:</strong> <a href="#" className="linksFooter">xxxxxXXXXxxxx.com</a> </div>
      ...
      <div className='d-flex d-lg-none SecondContainer px-2 py-3 gap-2'>
        ...
        <div className="d-inline d-lg-none textFooterSM"><strong>Follow us in:</strong> <a href="#" className="linksFooter">xxxxxXXXXxxxx.com</a> </div>
